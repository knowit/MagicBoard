...
var Loader = (function () {
    ...
    var getAllModules = function () {
        ...
        Object.entries(config.modules.boards).forEach(([key, value]) => {
            const board_number = key;
            Object.entries(value).forEach(([key, value]) => {
                const number_of_modules = value.length;
                const pos = key;
                ...
                Object.entries(value).forEach(([key, value]) => {
                    ...
                    if (modules.indexOf(module.module) === -1 && !module.disabled) {
                        ...
                        module["amount"] = number_of_modules;
                        module["board"] = parseInt(board_number);
                        modules.push(module);
                    }
                });
            });
        ...
        let footer = config.modules.footer[0];
